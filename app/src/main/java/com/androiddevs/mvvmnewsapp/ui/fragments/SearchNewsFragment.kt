...
import com.androiddevs.mvvmnewsapp.utils.toggleVisibility
...
class SearchNewsFragment : BaseFragment(R.layout.fragment_search_news) {
    ...
    private fun hideProgressBar() {
        paginationProgressBar.toggleVisibility(false)
        isLoading = false
    }

    private fun showProgressBar() {
        paginationProgressBar.toggleVisibility(true)
        isLoading = true
    }
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val shouldPaginate = isNotLoadingAndNotLastPage and isAtLastItem and isNotAtBeginning and
                    isTotalMoreThanVisible and isScrooling
            if (shouldPaginate) {
